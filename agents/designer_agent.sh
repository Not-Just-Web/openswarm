...
main() {
  ...
  append_chat "status" "I'm reviewing the UX and visual direction for this request."
  append_chat "done" "Design pass finished. I can refine the interface further if you want to steer it."
